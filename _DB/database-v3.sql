...
-- Dumping data for table safety_management.migrations: ~9 rows (approximately)
...
INSERT IGNORE INTO `migrations` (`id`, `migration`, `batch`) VALUES
	...
	(15, '2023_07_23_023922_add_status_column_to_safeties_table', 4);
/*!40000 ALTER TABLE `migrations` ENABLE KEYS */;

-- Dumping structure for table safety_management.organitations
DROP TABLE IF EXISTS `organitations`;
...
CREATE TABLE IF NOT EXISTS `safeties` (
  ...
  `post_mitigation` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `deadline` char(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dumping data for table safety_management.safeties: ~2 rows (approximately)
/*!40000 ALTER TABLE `safeties` DISABLE KEYS */;
INSERT IGNORE INTO `safeties` (`id`, `number`, `reporter`, `classification`, `date_of_submission`, `date_of_hazard_identification`, `location`, `type_operation`, `description`, `file_reporter`, `risk_probability`, `risk_severity`, `risk_index`, `cop`, `hm`, `co`, `responsible`, `post_mitigation`, `deadline`, `file_response`, `created_at`, `updated_at`, `status`) VALUES
	(16, 'HR0001/07/23', '160261', NULL, '2023-07-30', '2023-07-31', 'awd', '2', 'awdawd', 'http://127.0.0.1:9000/storage/file/20230730165438google.png', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2023-07-30 16:54:38', '2023-07-30 16:54:38', 'open'),
	(17, 'HR0001/07/23', '160262', NULL, '2023-07-30', '2023-07-31', 'awdwd', '1', 'awdawda', 'http://127.0.0.1:9000/storage/file/20230730171229WhatsApp Image 2023-07-04 at 12.57.51.jpeg', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2023-07-30 17:12:30', '2023-07-30 17:12:30', 'open');
